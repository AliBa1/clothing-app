    ...
    <div className='border-b pb-4'>
      <div className='flex gap-1 md:gap-4'>
        ...
        <div className='w-2/3 p-0 md:p-2 flex flex-col justify-between'>
          {/* <div className='border p-0 md:p-2 flex flex-col justify-between'> */}
          <div>
          ...
          <button className='hidden md:block btn-circle h-8 w-8 md:w-auto md:btn-secondary md:h-12 md:max-w-48'>
        ...
        <div className='hidden md:flex flex-col justify-between w-1/3 p-0 md:p-4'>
          {/* <div className='border flex flex-col items-end justify-between p-0 md:p-4 col-span-2 md:col-span-1'> */}
      ...
      <div className='md:hidden flex justify-between items-center pt-2'>
        {/* <div className='border flex flex-col items-end justify-between p-0 md:p-4 col-span-2 md:col-span-1'> */}
        <div className='hover:underline decoration-accent text-lg md:text-2xl font-heading text-end'>
          {cartProduct.color.discount ? (
            <p>
              $
              {discountedPrice(
        ...
        <div className='flex btn-secondary md:h-16 gap-4 items-center justify-between rounded-full border'>
          {/* <div className='flex btn-secondary md:h-16 items-center justify-between rounded-full border'> */}
          <button>
